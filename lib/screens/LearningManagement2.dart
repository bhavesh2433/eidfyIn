...
import './LearningManagement.dart';
import 'package:adobe_xd/page_link.dart';
import './authentication_screen.dart';
import './LearningManagement1.dart';
import 'package:flutter_svg/flutter_svg.dart';

class LearningManagement2 extends StatelessWidget {
  LearningManagement2({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 12.1, 19.0, 22.9),
                    size: Size(52.0, 52.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 3.9, 19.0, 19.0),
                          size: Size(19.0, 22.9),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(9.5, 0.0, 1.0, 12.7),
                          size: Size(19.0, 22.9),
                          pinTop: true,
                          fixedWidth: true,
                          fixedHeight: true,
...
const String _svg_kaxiue =
    '<svg viewBox="0.0 0.0 315.0 812.0" ><defs><filter id="shadow"><feDropShadow dx="5" dy="3" stdDeviation="6"/></filter></defs><path  d="M 0 0 L 315.04638671875 0 L 315.04638671875 812 L 0 812 L 0 0 Z" fill="#ffffff" fill-opacity="0.7" stroke="none" stroke-width="1" stroke-opacity="0.7" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
...
const String _svg_t3t656 =
    '<svg viewBox="33.5 742.1 1.0 12.7" ><path transform="translate(-2969.0, 2.48)" d="M 3002.5 739.587158203125 L 3002.5 752.2520751953125" fill="none" stroke="#ffffff" stroke-width="3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
