...
class LearningManagement1 extends StatelessWidget {
  LearningManagement1({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_kgqg0t =
    '<svg viewBox="0.0 0.0 316.6 812.0" ><defs><filter id="shadow"><feDropShadow dx="5" dy="3" stdDeviation="6"/></filter></defs><path  d="M 0 0 L 316.58935546875 0 L 316.58935546875 812 L 0 812 L 0 0 Z" fill="#ffffff" fill-opacity="0.7" stroke="none" stroke-width="1" stroke-opacity="0.7" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
...
const String _svg_fjgnyh =
    '<svg viewBox="18.0 252.0 27.0 7.0" ><path transform="matrix(-1.0, 0.0, 0.0, -1.0, 45.0, 259.0)" d="M 13.49999809265137 0 L 26.99999809265137 7 L 0 7 Z" fill="#0089c4" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_a8b1n3 =
    '<svg viewBox="18.0 254.0 27.4 15.2" ><path transform="translate(807.0, -3029.0)" d="M -789 3282.97998046875 L -789 3298.218994140625 L -761.595703125 3298.218994140625 L -761.595703125 3282.97998046875 L -775.2601928710938 3290.0654296875 L -789 3282.97998046875 Z" fill="#0089c4" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
